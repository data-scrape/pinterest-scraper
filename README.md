...
> Scrape Pinterest pins, boards, images without API

[![Python 3.11+](https://img.shields.io/badge/Python-3.11+-blue?style=flat-square&logo=python)](https://www.python.org/)
[![License: MIT](https://img.shields.io/badge/License-MIT-green?style=flat-square)](LICENSE)
[![Stars](https://img.shields.io/github/stars/data-scrape/pinterest-scraper?style=flat-square)](https://github.com/data-scrape/pinterest-scraper)
[![Forks](https://img.shields.io/github/forks/data-scrape/pinterest-scraper?style=flat-square)](https://github.com/data-scrape/pinterest-scraper/forks)
...
**Pinterest Scraper** is a free, open-source Python scraper for **Pinterest**. Extract structured data from pinterest with full pagination support, proxy rotation, and multiple export formats.

pinterest scraper, scrape pinterest, pinterest data scraper

## ✨ Features

- ✅ Pin image & description extraction
- ✅ Board information
- ✅ Pin engagement metrics
- ✅ Keyword-based pin search
- ✅ User profile data
- ✅ Bulk image download support
...
```bash
git clone https://github.com/data-scrape/pinterest-scraper.git
...
```bash
python scraper.py "minimalist home decor pins"
```
...
`pin_id` | `title` | `description` | `image_url` | `board_name` | `board_url` | `pinner_name` | `repins` | `saves` | `link` | `created_at`

## 💡 Use Cases

- Pinterest marketing research
- Trend & inspiration discovery
- Competitor content analysis
- Image collection for ML
